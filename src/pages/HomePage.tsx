  ...
  return <div className="page-wrap home-page">
    <section className="hero" aria-labelledby="naglowek-powitalny">
      <div className="hero-copy">
        <div className="hero-kicker"><span className="live-dot"/> Dzień dobry, Kapi. System działa.</div>
        <h1 id="naglowek-powitalny">Pomysły zamieniam<br/><span>w działające projekty.</span></h1>
        <p>Jedno miejsce do śledzenia narzędzi, testów, publikacji i decyzji podejmowanych razem ze społecznością.</p>
        <div className="hero-actions"><Link className="button primary" to="/projekty">Zobacz projekty <Icon name="arrow" size={17}/></Link></div>
      </div>
      <div className="hero-banner" role="img" aria-label="Nastrojowa ilustracja stanowiska pracy z monitorami i ciepłym światłem">
        <div className="hero-screen" aria-hidden="true"><span/><span/></div>
        <div className="hero-status"><span className="live-dot"/> Ostatnia synchronizacja: teraz</div>
      </div>
    </section>

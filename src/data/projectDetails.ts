...
export type AktualizacjaProjektu = { id:string; data?:string; dataWykonania?:string; dataPublikacji?:string; tytul?:string; tresc:string; zmiana?:string; media?:Array<string | MediumGalerii>; zalaczniki?:string[]; kamienMilowyId?:string };
...
export type RelacjaProjektu = { typ:'oryginalny'|'rozwinięcie'|'modyfikacja'|'alternatywna wersja'|'fork'|'autorski'; projektZrodlowySlug?:string };
...
export const szczegolyProjektow: Record<string, SzczegolyProjektu> = {
  'po-kapiemu': {
    ...
    openSource:true, repozytorium:{nazwa:'Po Kapiemu',provider:'GitHub',url:'https://github.com/kapi1944/Po_Kapiemu',opis:'Kod źródłowy portalu i kart projektów.'}, wersje:[{nazwa:'v0.3',data:'2026-07-30',dojrzalosc:'Wczesny prototyp',zmiany:['Modulowe sekcje','Galeria etapow']},{nazwa:'v0.2',data:'2026-07-12',dojrzalosc:'Koncepcja',zmiany:['Pierwszy uklad']}],

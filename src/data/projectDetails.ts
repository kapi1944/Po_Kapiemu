...
export const szczegolyProjektow: Record<string, SzczegolyProjektu> = {
  'po-kapiemu': {
    ...
    kolejnoscSekcji:['najwazniejsze','aktualizacje','galeria','glosowania','komentarze','materialy','zbuduj-sam','czesci-i-koszty','dokumentacja'], wyroznioneSekcje:['najwazniejsze'],
  },

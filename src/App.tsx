...
export default function App() {
  return <BrowserRouter><Routes><Route element={<Layout/>}>
    ...
    <Route path="/glosowania" element={<PollsPage/>}/><Route path="/tresci" element={<ContentPage/>}/><Route path="/recenzje" element={<ReviewsHubPage/>}/><Route path="/szukaj" element={<SearchResultsPage/>}/>
